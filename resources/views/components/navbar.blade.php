<nav id="navbar" class="fixed top-0 left-0 w-full flex justify-between items-center py-7 px-8 md:px-16 z-50 bg-transparent border-b border-transparent transition-all duration-300">
    ...
    <ul class="hidden md:flex gap-10 list-none m-0 p-0">
        <li><a href="#about" class="text-white/80 no-underline text-[11px] font-medium tracking-[1.5px] uppercase transition-all duration-300 hover:text-white">Tentang</a></li>
        <li><a href="#works-section" class="text-white/80 no-underline text-[11px] font-medium tracking-[1.5px] uppercase transition-all duration-300 hover:text-white">Karya</a></li>
        <li><a href="#services" class="text-white/80 no-underline text-[11px] font-medium tracking-[1.5px] uppercase transition-all duration-300 hover:text-white">Layanan</a></li>
        <li><a href="#journal" class="text-white/80 no-underline text-[11px] font-medium tracking-[1.5px] uppercase transition-all duration-300 hover:text-white">Jurnal</a></li>
        <li><a href="#contact" class="text-white/80 no-underline text-[11px] font-medium tracking-[1.5px] uppercase transition-all duration-300 hover:text-white">Kontak</a></li>
    </ul>
</nav>
