<section id="contact" class="w-full h-auto lg:h-screen bg-[#111] px-4 md:px-10 py-16 lg:pt-32 lg:pb-12 relative z-[11] font-sans flex flex-col justify-start lg:justify-end">
    <div class="w-full">
        <div class="grid lg:grid-cols-2 gap-10 md:gap-20 mb-16 items-start text-left">
            <div class="flex flex-col pt-8 md:pt-12">
                <h2 class="text-white text-2xl md:text-3xl lg:text-[38px] font-medium tracking-tight leading-[1.3] max-w-2xl mb-10">
                    Konsultasikan kebutuhan kreatif untuk menunjang moment anda.<br>
                    Woodezig siap membantu dari konsep hingga produksi.
                </h2>
                <a href="https://wa.me/62823456789" target="_blank"
                   class="group flex items-center gap-3 text-white text-[13px] tracking-[2px] uppercase no-underline pb-2 border-b border-white/20 hover:border-primary transition-colors duration-300 w-fit">
                    AYO DISKUSI
            ...
            <div class="hidden lg:flex justify-start items-start -mt-4 xl:-mt-8">
                <img 
                    src="{{ asset('logo/Footer-Text.png') }}" 
                    alt="Woodezig Footer Text"
                    class="w-[420px] xl:w-[580px] object-contain opacity-80"
                />
            </div>
        </div>
            ...
            <div class="flex flex-col space-y-6">
                ...
                <div class="flex flex-col gap-5">
                    <div class="flex items-center gap-5 text-white/60 hover:text-white transition-colors duration-300">
                        ...
                        <a href="https://instagram.com/woodezig" target="_blank" class="text-[13px]">
                            Instagram
                        </a>
                    </div>
                    <div class="flex items-center gap-5 text-white/60 hover:text-white transition-colors duration-300">
