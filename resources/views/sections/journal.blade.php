<section class="py-24 px-8 md:px-16 bg-[#060606] relative border-t border-white/5 font-sans" id="journal">
    ...
    <div class="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-8">
        <h2 class="journal-section-title text-white text-6xl md:text-8xl lg:text-[110px] font-sans font-bold tracking-tighter leading-none uppercase">
            / JURNAL
        </h2>

        <a href="#" class="group flex items-center gap-3 text-white text-[13px] font-sans tracking-[2px] uppercase no-underline pb-2 border-b border-white/20 hover:border-white transition-colors duration-300">
            SEMUA JURNAL 
